...
EMA_LONG_PERIOD = 200         # EMA200 — long-term daily trend (MTF)

# ─────────────────────────────── Multi-Timeframe Analysis ────────────────────
# Enable the Daily → 4H → 1H → Footprint top-down methodology.
# When True, signals require MTF confluence (at least 3/4 layers aligned).
MTF_ENABLED            = True
MTF_MIN_CONFLUENCE     = 3     # minimum layers (out of 4) needed for entry
MTF_REQUIRE_1H_PATTERN = True  # require a 1H confirmation pattern
MTF_4H_NEAR_LEVEL_PCT  = 0.003 # 0.3% proximity to a 4H S/R level
...
TP_RATIO             = 2.0    # take-profit 1 at 2× the risk (1:2 R:R)
TP_RATIO_2           = 3.0    # take-profit 2 at 3× the risk (1:3 R:R) — runner
...
PARTIAL_PROFIT_R     = 1.0    # take 50% position off at TP1 (2R)
PARTIAL_PROFIT_PCT   = 0.5    # fraction of position closed at TP1
